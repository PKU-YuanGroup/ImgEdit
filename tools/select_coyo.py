...
# api_version="gpt-4.1-mini_2025-04-14"
# stupid_model_name='gpt-4.1_2025-04-14' #'gpt-4o-mini_2024-07-18'
# clever_model_name='gpt-4.1_2025-04-14' #'gpt-4o_2024-11-20' #'gpt-4o-mini_2024-07-18'
clever_model_name='gpt-4o_2024-11-20'
clever_model_name = 'sss'
# clever_model_name="gpt-4.1-mini_2025-04-14"
# stupid_model_name="gpt-4.1-mini_2025-04-14"
# clever_model_name="gpt-4.1-nano_2025-04-14"
        ...
        if instruction_type == "background":
            ...
            for i in range(len(obj_list)):
                ...
                if valid_obj_candidate(bbox, img_area, score, clip_score, a_threshold=0.08, s_threshold=0.8, c_threshold=0.8): 
                    candidate.append(i)
            if resolution[0]>=1024 and resolution[1]>=1024 and len(candidate) == 1:
                shit.append(batch['path'])
                return 
            else:
                return
            if len(candidate) == 0:
