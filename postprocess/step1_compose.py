...
prompt = """
You are a data rater specializing in grading image editing tasks. You will be given two images (before and after editing) and the corresponding edit instructions, Your task is to evaluate the editing effect on a 5-point scale from three perspectives:
...
def process_folder(folder, api_key):
    original_png = os.path.join(folder, 'origin_0.png')
    result_png = os.path.join(folder, 'result_1.png')
