...
def process_task(workflow_endpoint, data_list, progress_bar=None):
    ...
    for data in data_list:
        ...
        if task.edit_type[0] == "remove":
            if os.path.exists(os.path.join(output_dir, "result_0.png")):
                progress_bar.update(1)
                continue
            ...
            try:
                ...
                progress_bar.update(1)
                continue
        elif task.edit_type[1] == "remove":
            if not os.path.exists(os.path.join(output_dir, "result_0.png")):
                progress_bar.update(1)
                continue
