...
def process_task(workflow_endpoint, data_list, progress_bar=None):
    ...
    for data in data_list:
        ...
        if "replace" not in task.edit_type:
            progress_bar.update(1)
            continue
        
        if task.edit_type[0] == "replace" and not os.path.exists(os.path.join(output_dir, "result_0.png")):
            ...
            try:
                ...
                progress_bar.update(1)
                continue
        elif task.edit_type[1] == "replace" and os.path.exists(os.path.join(output_dir, "result_0.png")) and not os.path.exists(os.path.join(output_dir, "result_1.png")):
