...
from schemas import AdjustCannyTask
...
def process_task(workflow_endpoint, data_list, progress_bar=None):
    ...
    for data in data_list:
        with open(data, "r") as f:
            data = json.load(f)
        task = AdjustCannyTask.model_validate(data)
...
def adjust_canny(data_list, workers):
...
if __name__ == "__main__":
    ...
    dlc_context_runner(adjust_canny, wait_time=120, data_list=data_list)