...
TASK_KWARGS="--json_dir /mnt/data/yangye/imgedit/data/inpaint_input/step5/laion_part1/ \
--base_img_dir /mnt/data/osp/imgdata/laion-aes \
--result_dir results_extract_ref_part1" 

mkdir -p logs

if [ $RANK -eq 0 ]; then
    # if is master
    $PYTHONPATH dlc_extract_ref.py $TASK_KWARGS &
