...
TASK_KWARGS="--json_dir /mnt/data/yangye/imgedit/data/step5/laion_part2_adj/ \
--base_img_dir /mnt/data/osp/imgdata/laion-aes \
--result_dir results_adjust_canny_laion_part2" 

mkdir -p logs

if [ $RANK -eq 0 ]; then
    # if is master
    $PYTHONPATH dlc_adjust_canny.py $TASK_KWARGS &
