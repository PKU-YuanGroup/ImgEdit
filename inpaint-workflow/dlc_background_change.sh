...
TASK_KWARGS="--json_dir /mnt/data/yangye/imgedit/data/step5/laion_part0_bg/ \
--base_img_dir /mnt/data/osp/imgdata/laion-aes \
--result_dir results_background_laion_part0" 

mkdir -p logs

if [ $RANK -eq 0 ]; then
    # if is master
    $PYTHONPATH dlc_background_change.py $TASK_KWARGS &
